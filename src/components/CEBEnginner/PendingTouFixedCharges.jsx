...
const PendingTouFixedCharges = ({ setVisibleState4 }) => {
  ...
  const [touFCharge, setTouFCharge] = useState("");
  const [touReqFCharge, setTouReqFCharge] = useState("");
            ...
            <TableRow>
              ...
              <TableCell>
                <button
                  ...
                  onClick={() => setDataToPopup(item.Fixed_charge, item.Time_category, item.Update_fixed_charges, "Fixed")}
                ...
                <button
                  ...
                  onClick={() => {
                    setConfirmDialog({
                      ...
                      btnStatus: "danger",
                      onConfirm: () => {
                        onDeletedevice(item.Time_category, "Fixed");
                      },
                    });
                  }}
              ...
              <MyVerticallyCenteredModal
                fixedPrice={touFCharge}
                reqFixedPrice={touReqFCharge}
