...
export default function PendingNormalUnitCharges({ setVisibleState1 }) {

  const [modalShow, setModalShow] = React.useState(false);

  const [normalUCharge, setNormalUCharge] = useState("");
  const [normalReqUCharge, setNormalReqUCharge] = useState("");
  ...
  function setDataToPopup(value, unitPeriod, requestValue, categ) {
    ...
    setNormalReqUCharge(requestValue);
            ...
            <TableRow>
              ...
              <TableCell>
                <button
                  ...
                  onClick={() => setDataToPopup(item.Unit_charge, item.Unit_category, item.Update_unit_charges, "Unit")}
                >
                  <EditOutlined
                    fontSize="small"
