...
export async function insertDevice(data) {
    ...
    // e.preventDefault();
    console.log(data);
    await Axios.post(`${process.env.REACT_APP_BASE_URL}/add-device-special-TOUbill/${ParamsUserId}`, {
        data: data
    }, {
        headers: {
...
export async function updateDevice(data,id) {
    ...
    await Axios.post(`${process.env.REACT_APP_BASE_URL}/update-device-special-TOUbill/${ParamsUserId}`, {
        data: data,
        bill_id:id
...
export async function Deletedevice(device_id,newBillId) {
    ...
    await Axios.post(`${process.env.REACT_APP_BASE_URL}/delete-device-special-TOUbill/${ParamsUserId}`, {
        device_id: device_id,
        bill_id:newBillId
    }, {
        headers: {
...
export async function getAllDevices(newBillId) {
   ...
   console.log("GetAllDevicesFixed");
    ...
    const response = await Axios.post(`${process.env.REACT_APP_BASE_URL}/get-specialEvent-TOUDetails/${ParamsUserId}`, {
        newBillId: newBillId
    }, {
        headers: {
            authorization: `Token ${token}`
